...
def main():
    ...
    try:
        ...
        s1.push_update_add_entry_to_action(
            req,
            "egress.permission_acl_egress.permission_acl_egress_table",
            [s1.Ternary("local_metadata.role_id", '\x01', '\x7f'), s1.Ternary("standard_metadata.egress_port", '\x00\x01', '\x01\xff')],
            "NoAction", [], 100)
        s1.write_request(req)
        ...
        s1.push_update_add_entry_to_action(
            ...
            "ingress.table2_control.table2",
            [s1.Ternary("standard_metadata.ingress_port", '\x00\x02', '\x01\xff')],
            "ingress.table2_control.set_egress_port", [("port", b'\x00\x01')], 100)
        s1.write_request(req)
        ...
        s1.push_update_add_entry_to_action(
            ...
            "egress.process_int_transit.init_metadata", [("switch_id", b'\x00\x00\x00\x16')], 0)
        s1.write_request(req)
